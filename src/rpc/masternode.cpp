...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner QuestChain address\n"
            "  payee          - Print the masternode payout QuestChain address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting QuestChain address\n"
        );
}
...
void masternode_count_help()
{
    throw std::runtime_error(
            ...
            "  ps            - number of QuestChainSend compatible masternodes"
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "questchain",               "masternode",             &masternode,             {} },
    { "questchain",               "masternodelist",         &masternodelist,         {} },
};
