/* src/config/questchain-config.h.  Generated from questchain-config.h.in by configure.  */
/* src/config/questchain-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PRIV_CONFIG_H

#define PRIV_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The QuestChain Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "QuestChain Core"
...
#define PACKAGE_BUGREPORT "https://github.com/questchainpay/questchain/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "QuestChain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "QuestChain Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "questchaincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://questchain.org/"
