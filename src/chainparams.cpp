...
{
    const char* pszTimestamp = "Trump’s New York hush money trial continues after sleepy start to jury selection";
    const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b104ad4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
static void FindMainNetGenesisBlock(uint32_t nTime, uint32_t nBits, const char* network)
{
    ...
    CBlock block = CreateGenesisBlock(nTime, 0, nBits, 1,5000 * COIN);
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1714400165, 2840, 0x1f0fffff, 1, 5000 * COIN);
    ...
    /*    // just for now
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00054c0797a4d2256d75c23a1333a4b7064002eecf987e629c9c5d28130117ff"));
        assert(genesis.hashMerkleRoot == uint256S("0x228c8fc95ad38342d2e91ec07e30f1388c39a3898d70cc46a665badf6c068aa7"));
        ...
        vSeeds.emplace_back("node.questchain.io");
	vSeeds.emplace_back("pool.questchain.io");
	vSeeds.emplace_back("explorer.questchain.io");
	vSeeds.emplace_back("node-en.questchain.io");
	vSeeds.emplace_back("node-us.questchain.io");
	vSeeds.emplace_back("node-ru.questchain.io");
	base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,58);
        ...
        vSporkAddresses = {"QcWYigS3ccpcB1GoG6dCuBPCHU9sV9fXWg"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1714146974, // * UNIX timestamp of last known number of transactions (Block 1344000)
...
public:
    CTestNetParams() {
      ...
      //  assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        ...
        vSeeds.emplace_back("testnet-seed.dot.io"); // Just a static list of stable node(s), only supports x9
...
public:
    ...
    //    assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("evo.org",  "devnet-seed.privcyevo.org"));
