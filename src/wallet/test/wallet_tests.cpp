    ...
    // after.
    {
        ...
        BOOST_CHECK_EQUAL(response.write(),
            strprintf("[{\"success\":false,\"error\":{\"code\":-1,\"message\":\"Rescan failed for key with creation "
                      ...
                      "by pruning or data corruption (see questchaind log for details) and could be dealt with by "
...
public:
    ...
    const std::string strUnableToLocateQuestChainSend1 = "Unable to locate enough QuestChainSend non-denominated funds for this transaction.";
    const std::string strUnableToLocateQuestChainSend2 = "Unable to locate enough QuestChainSend denominated funds for this transaction. QuestChainSend uses exact denominated amounts to send funds, you might simply need to mix some more coins.";
...
BOOST_FIXTURE_TEST_CASE(CreateTransactionTest, CreateTransactionTestSetup)
{
    ...
    // Test error cases
    {
        ...
        // First try to send something without any coins available
        {
            ...
            BOOST_CHECK(CreateTransaction({{1000, true}}, strUnableToLocateQuestChainSend1, false));
            coinControl.nCoinType = CoinType::ONLY_FULLY_MIXED;
            BOOST_CHECK(CreateTransaction({{1000, true}}, strUnableToLocateQuestChainSend2, false));
