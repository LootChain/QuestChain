...
public:
    ...
    // QuestChain-specific helpers

    void UseQuestChainSend(bool fUseQuestChainSend)
    {
        nCoinType = fUseQuestChainSend ? CoinType::ONLY_FULLY_MIXED : CoinType::ALL_COINS;
    }

    bool IsUsingQuestChainSend() const
    {
