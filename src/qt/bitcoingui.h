...
private:
    ...
    QToolButton *questchainSendCoinsAction;
    QAction *questchainSendCoinsMenuAction;
    ...
    QAction *showQuestChainSendHelpAction;
...
private Q_SLOTS:
    ...
    /** Switch to QuestChainSend coins page */
    void gotoQuestChainSendCoinsPage(QString addr = "");
    ...
    /** Open external (default) editor with questchain.conf */
    void showConfEditor();
    ...
    /** Show QuestChainSend help message dialog */
    void showQuestChainSendHelpClicked();
#ifndef Q_OS_MAC
    ...
    void updateQuestChainSendVisibility();
