    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  questchain-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        setWindowTitle(tr("QuestChainSend information"));

        ui->aboutMessage->setTextFormat(Qt::RichText);
        ui->scrollArea->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        ui->aboutMessage->setText(tr("\
<h3>QuestChainSend Basics</h3> \
QuestChainSend gives you true financial privacy by obscuring the origins of your funds. \
All the QuestChain in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
QuestChainSend uses an innovative process to mix your inputs with the inputs of two or more other people, without having your coins ever leave your wallet. \
You retain control of your money at all times.<hr> \
<b>The QuestChainSend process works like this:</b>\
<ol type=\"1\"> \
<li>QuestChainSend begins by breaking your transaction inputs down into standard denominations. \
These denominations are 0.001 QCH, 0.01 QCH, 0.1 QCH, 1 QCH and 10 QCH -- sort of like the paper money you use every day.</li> \
...
Each time the process is completed, it's called a \"round.\" Each round of QuestChainSend makes it exponentially more difficult to determine where your funds originated.</li> \
...
Consequently, users who have backups disabled will also have QuestChainSend disabled. <hr>\
For more information, see the <a style=\"%1\" href=\"https://docs.questchain.org/en/stable/wallets/questchaincore/questchainsend-instantsend.html\">QuestChainSend documentation</a>."
