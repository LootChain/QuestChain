...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    ...
    case TransactionRecord::RecvWithQuestChainSend:
        return tr("Received via QuestChainSend");
    ...
    case TransactionRecord::QuestChainSendDenominate:
        return tr("QuestChainSend Denominate");
    case TransactionRecord::QuestChainSendCollateralPayment:
        return tr("QuestChainSend Collateral Payment");
    case TransactionRecord::QuestChainSendMakeCollaterals:
        return tr("QuestChainSend Make Collateral Inputs");
    case TransactionRecord::QuestChainSendCreateDenominations:
        return tr("QuestChainSend Create Denominations");
    case TransactionRecord::QuestChainSend:
        return "QuestChainSend";
