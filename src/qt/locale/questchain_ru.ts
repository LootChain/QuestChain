...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса QuestChain для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса QuestChain для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: если Вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ QCH&lt;/b&gt;!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Дальнейшая безопасная работа QuestChain Core невозможна, программа будет закрыта.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес QuestChain</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запросить платежи (создать QR-коды и questchain: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о QuestChain Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить монеты на QuestChain адрес с помощью QuestChainSend</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашими адресами QuestChain, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определёнными адресами QuestChain</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть questchain: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Информация о &amp;QuestChainSend</translation>
    </message>
    <message>
        <source>Show the QuestChainSend basic information</source>
        <translation>Показать краткую информацию о QuestChainSend</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное соединение с сетью QuestChain</numerusform><numerusform>%n активных соединения с сетью QuestChain</numerusform><numerusform>%n активных соединений с сетью QuestChain</numerusform><numerusform>%n активных соединений с сетью QuestChain</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Скрыть QuestChainSend монеты</translation>
    </message>
    <message>
        <source>Show all QuestChainSend coins</source>
        <translation>Показать все QuestChainSend монеты</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным адресом QuestChain.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;h3&gt;Основы QuestChainSend&lt;/h3&gt;QuestChainSend позволяет Вам получить настоящую финансовую конфиденциальность за счет скрытия источников Ваших средств. Все QuestChain в  Вашем кошельке состоят из различных "входов", Вы можете думать о них как об отдельных монетах.&lt;br&gt;QuestChainSend использует инновационный процесс для перемешивания Ваших входов со входами еще двоих или более человек, но при этом Ваши монеты никогда не покидают Ваш кошелек. Вы сохраняете контроль над Вашими деньгами на протяжении всего времени.&lt;hr&gt; &lt;b&gt;QuestChainSend работает так:&lt;/b&gt;&lt;ol type="1"&gt; &lt;li&gt;QuestChainSend начинается с разбиения Ваших входов транзакций на стандартные номиналы. Такими номиналами являются 0.001 QCH, 0.01 QCH, 0.1 QCH, 1 QCH и 10 QCH -- что-то вроде купюр, которыми вы пользуетесь каждый день.&lt;/li&gt; &lt;li&gt;Ваш кошелек затем отправляет запросы к особым образом настроенным сетевым узлам, называемым "мастернодами". Эти мастерноды знают только то, что Вы хотите перемешать определенные номиналы. Никакой идентифицирующей информации мастернодам не отправляется, так что они не знают "кто" Вы конкретно.&lt;/li&gt; &lt;li&gt;Сессия перемешивания начинается тогда, когда еще двое или более человек отправляют схожее сообщение, подтверждающее, что они хотят перемешать точно такой же номинал. Мастернода перемешивает входы и просит кошельки всех пользователей осуществить платежи по ним. Ваш кошелек осуществляет выплату самому себе, но на другой адрес (тоже из вашего кошелька).&lt;/li&gt; &lt;li&gt;Для скрытия Ваших средств кошелек должен повторить этот процесс несколько раз с каждым номиналом. Каждый раз, когда такой процесс завершается, называется "раундом". С каждым раундом QuestChainSend становится экспоненциально сложнее определить откуда поступили средства.&lt;/li&gt; &lt;li&gt;Процесс перемешивания выполняется в фоне, без участия пользователя. Когда Вы захотите провести транзакцию, средства уже будут перемешаны. Дополнительно ждать не требуется.&lt;/li&gt; &lt;/ol&gt; &lt;hr&gt;&lt;b&gt;ВАЖНО:&lt;/b&gt; Ваш кошелек содержит 1000 адресов. Каждое перемешивание использует до 9 из этих адресов. Это означает, что 1000 адресов хватит примерно на 100 перемешиваний. Когда 900 адресов будут уже использованы, Ваш кошелек должен создать новые адреса. Однако, он может сделать это, только если у Вас включены автоматические резервные копии.&lt;br&gt;Соответственно, пользователям с отключенным резервным копированием QuestChainSend не доступен. &lt;hr&gt;Дополнительная информация доступна в  &lt;a style="%1" href="https://docs.questchain.org/en/stable/wallets/questchaincore/questchainsend-instantsend.html"&gt;документации QuestChainSend&lt;/a&gt;.</translation>
    </message>
</context>
<context>
    <name>Intro</name>
    ...
    <message>
        ...
        <translation>%1 скачает и сохранит копию цепочки блоков QuestChain.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Последние транзакции пока что могут быть не видны и поэтому ваш баланс может отображаться некорректно. Информация будет корректироваться по мере синхронизации с сетью QuestChain, подробности о ходе синхронизации представлены ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Показывать дополнительную информацию и кнопки для QuestChainSend на обзорной вкладке.</translation>
    </message>
    <message>
        <source>Enable advanced QuestChainSend interface</source>
        <translation>Включить расширенный интерфейс QuestChainSend</translation>
    </message>
    <message>
        <source>Show warning dialog when QuestChainSend detects that wallet has very low number of keys left.</source>
        <translation>Показывать предупреждение, когда QuestChainSend обнаружит, что в кошельке осталось слишком мало ключей.</translation>
    </message>
    <message>
        <source>Warn if QuestChainSend is running out of keys</source>
        <translation>Предупредить, если кончаются ключи для QuestChainSend</translation>
    </message>
    <message>
        ...
        <translation>Использовать или нет экспериментальный режим QuestChainSend с множественным перемешивание за один блок.&lt;br/&gt;Примечание: Используйте с осторожностью.&lt;br/&gt;Убедитесь, что у вас всегда есть (автоматический) бэкап в безопасном месте!</translation>
    </message>
    <message>
        <source>Enable QuestChainSend &amp;multi-session</source>
        <translation>Включить &amp;мульти-сессионный QuestChainSend</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Количество раундов QuestChainSend</translation>
    </message>
    <message>
        <source>This amount acts as a threshold to turn off QuestChainSend once it's reached.</source>
        <translation>Это пороговое значение, при достижении которого QuestChainSend отключается.</translation>
    </message>
    <message>
        <source>Target QuestChainSend balance</source>
        <translation>Целевой баланс QuestChainSend</translation>
    </message>
    <message>
        ...
        <translation>Автоматически открыть порт для QuestChain Core на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети QuestChain через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показывать всплывающие уведомления для транзакций перемешивания QuestChainSend&lt;br/&gt;также как для всех остальных типов транзакций.</translation>
    </message>
    <message>
        <source>Show popups for QuestChainSend transactions</source>
        <translation>Показывать всплывающие уведомления для транзакций QuestChainSend</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети QuestChain через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью QuestChain после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>0 QCH / 0 раундов</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Баланс QuestChainSend:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Если Вы не хотите видеть внутренние транзакции/комиссии от работы QuestChainSend, выберите Тип "Наиболее общие" на закладке "Транзакции".</translation>
    </message>
    <message>
        <source>QuestChainSend requires at least %1 to use.</source>
        <translation>Для работы QuestChainSend требуется минимум %1.</translation>
    </message>
    <message>
        <source>Wallet is locked and user declined to unlock. Disabling QuestChainSend.</source>
        <translation>Бумажник заблокирован и пользователь отказался его разблокировать. QuestChainSend будет выключен.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик questchain: click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось разобрать URI! Возможно указан некорректный адрес QuestChain либо параметры URI сформированы неверно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес QuestChain (например, %1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть QuestChain.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса.&lt;br&gt;Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть QuestChain.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Подтвердить отправку с помощью QuestChainSend</translation>
    </message>
    <message>
        <source>QuestChainSend funds only</source>
        <translation>только средства QuestChainSend</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>(комиссии у транзакций QuestChainSend как правило выше поскольку у них отсутствует сдача)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: Использование транзакции QuestChainSend с %1 и более входами может повредить вашей приватности и потому не рекомендуется</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес QuestChain</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес QuestChain для отправки на него монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия будет вычтена из отправляемой суммы. Получателю придет меньше QuestChain, сем указано в поле "Сумма". Если указано несколько получателей, то комиссия будет разделена между ними поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К questchain: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть QuestChain.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вы можете подписывать сообщения своими адресами, чтобы доказать, что Вы можете получать QuestChain на них. Будьте осторожны, не подписывайте что-то неопределённое, так как фишинговые атаки могут обманным путём заставить вас подписать нежелательные сообщения. Подписывайте только те сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The QuestChain address to sign the message with</source>
        <translation>Адрес QuestChain, которым Вы хотите подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом QuestChain</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес QuestChain, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified QuestChain address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом QuestChain</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Получено через QuestChainSend</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Перемешивание QuestChainSend</translation>
    </message>
    <message>
        <source>QuestChainSend Collateral Payment</source>
        <translation>Обеспечительный платеж QuestChainSend</translation>
    </message>
    <message>
        <source>QuestChainSend Make Collateral Inputs</source>
        <translation>Создание обеспечительных монет для QuestChainSend</translation>
    </message>
    <message>
        <source>QuestChainSend Create Denominations</source>
        <translation>Создание номиналов для QuestChainSend</translation>
    </message>
    <message>
        <source>watch-only</source>
        <translation>для просмотра</translation>
...
<context>
    ...
    <message>
        ...
        <translation>При отправке QuestChainSend использует только деноминированные средства, возможно, Вам просто нужно перемешать немного больше монет.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Включить множественное перемешивание QuestChainSend за один блок (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обнаружить достаточных для выполнения этой транзакции номиналов QuestChainSend.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Последнее действие QuestChainSend было слишком недавно.</translation>
    </message>
    <message>
        <source>Last successful QuestChainSend action was too recent.</source>
        <translation>Последнее успешное действие QuestChainSend было слишком недавно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>QuestChainSend в режиме ожидания.</translation>
    </message>
    <message>
        <source>QuestChainSend options:</source>
        <translation>Опции QuestChainSend:</translation>
    </message>
    <message>
        <source>QuestChainSend request incomplete:</source>
        <translation>Запрос QuestChainSend не завершен:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Целевой баланс QuestChainSend (%u-%u, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Разрешить перемешивание QuestChainSend для средств, хранящихся в этом кошельке (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запускать QuestChainSend автоматически (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
