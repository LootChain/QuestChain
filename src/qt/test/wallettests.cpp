...
//
//     src/qt/test/test_questchain-qt -platform xcb      # Linux
//     src/qt/test/test_questchain-qt -platform windows  # Windows
//     src/qt/test/test_questchain-qt -platform cocoa    # macOS
void TestGUI()
{
    GUIUtil::loadFonts();
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: questchain:")) != -1);
