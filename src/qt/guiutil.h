...
/** Utility functions used by the QuestChain Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "questchain:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load questchain specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a questchain specific theme is activated (light/dark).*/
