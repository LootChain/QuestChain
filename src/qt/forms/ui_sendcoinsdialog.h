...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 QCH"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 QCH"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 QCH"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 QCH"));
        ...
        verticalSpacer_7 = new QSpacerItem(1, 10, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayoutFee7->addItem(verticalSpacer_7);
        ...
        verticalLayoutFee7->addWidget(fallbackFeeWarningLabel);
        ...
        verticalLayoutFee8->setContentsMargins(-1, 3, -1, -1);
        ...
        horizontalLayoutFee13->setStretch(2, 1);
        ...
        verticalLayoutFee4->setContentsMargins(-1, 20, -1, 3);
        ...
        verticalLayoutFee9->setContentsMargins(-1, 30, -1, -1);
        ...
        verticalLayoutFee3->setContentsMargins(-1, 0, -1, 3);
        ...
        labelBalanceText = new QLabel(SendCoinsDialog);
        ...
        labelBalance->setText(QStringLiteral("123.456 QCH"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
...
#endif // QT_NO_TOOLTIP
        fallbackFeeWarningLabel->setText(QApplication::translate("SendCoinsDialog", "Note: Not enough data for fee estimation, using the fallback fee instead.", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 duffs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 duffs in fee,<br />while \"at least\" pays 1000 duffs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for questchain transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for questchain transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        labelBalanceText->setText(QApplication::translate("SendCoinsDialog", "Balance:", Q_NULLPTR));
    } // retranslateUi
