...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        showAddressQRCode = new QPushButton(AddressBookPage);
        showAddressQRCode->setObjectName(QStringLiteral("showAddressQRCode"));
        showAddressQRCode->setAutoDefault(false);

        horizontalLayout->addWidget(showAddressQRCode);
...
#ifndef QT_NO_TOOLTIP
        showAddressQRCode->setToolTip(QApplication::translate("AddressBookPage", "Show QR code for the currently selected address", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        showAddressQRCode->setText(QApplication::translate("AddressBookPage", "&Show QR code", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
