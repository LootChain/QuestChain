...
class CQuestChainSendServer;
class UniValue;

// The main object for accessing mixing
extern CQuestChainSendServer questchainSendServer;

/** Used to keep track of current status of mixing pool
 */
class CQuestChainSendServer : public CQuestChainSendBaseSession, public CQuestChainSendBaseManager
{
private:
    ...
    bool AddEntry(CConnman& connman, const CQuestChainSendEntry& entry, PoolMessage& nMessageIDRet);
    ...
    bool IsAcceptableDSA(const CQuestChainSendAccept& dsa, PoolMessage& nMessageIDRet);
    bool CreateNewSession(const CQuestChainSendAccept& dsa, PoolMessage& nMessageIDRet, CConnman& connman);
    bool AddUserToExistingSession(const CQuestChainSendAccept& dsa, PoolMessage& nMessageIDRet);
