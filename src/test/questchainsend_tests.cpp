// Copyright (c) 2020 The QuestChain Core developers
...
BOOST_FIXTURE_TEST_SUITE(questchainsend_tests, BasicTestingSetup)

BOOST_AUTO_TEST_CASE(ps_collatoral_tests)
{
    // Good collateral values
    BOOST_CHECK(CQuestChainSend::IsCollateralAmount(0.00010000 * COIN));
    BOOST_CHECK(CQuestChainSend::IsCollateralAmount(0.00012345 * COIN));
    BOOST_CHECK(CQuestChainSend::IsCollateralAmount(0.00032123 * COIN));
    BOOST_CHECK(CQuestChainSend::IsCollateralAmount(0.00019000 * COIN));

    // Bad collateral values
    BOOST_CHECK(!CQuestChainSend::IsCollateralAmount(0.00009999 * COIN));
    BOOST_CHECK(!CQuestChainSend::IsCollateralAmount(0.00040001 * COIN));
    BOOST_CHECK(!CQuestChainSend::IsCollateralAmount(0.00100000 * COIN));
    BOOST_CHECK(!CQuestChainSend::IsCollateralAmount(0.00100001 * COIN));
}
