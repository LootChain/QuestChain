#!/usr/bin/env python3
# Copyright (c) 2015-2020 The QuestChain Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
from collections import namedtuple

from test_framework.mininode import *
from test_framework.test_framework import QuestChainTestFramework
...
class LLMQCoinbaseCommitmentsTest(QuestChainTestFramework):
    def set_test_params(self):
        self.set_questchain_test_params(4, 3, fast_dip3_enforcement=True)
        self.set_questchain_dip8_activation(200)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as QuestChainTestFramework doesn't support this atm)
