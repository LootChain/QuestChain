...
class LLMQ_IS_RetroactiveSigning(QuestChainTestFramework):
    def set_test_params(self):
        # -whitelist is needed to avoid the trickling logic on node0
        self.set_questchain_test_params(6, 5, [["-whitelist=127.0.0.1"], [], [], [], ["-minrelaytxfee=0.001"], ["-minrelaytxfee=0.001"]], fast_dip3_enforcement=True)
        self.set_questchain_llmq_test_params(5, 3)
        self.set_questchain_dip8_activation(10)
