...
"""Verify that starting questchaind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start questchaind with -h for help text")
        ...
        self.log.info("Start questchaind with -version for version information")
