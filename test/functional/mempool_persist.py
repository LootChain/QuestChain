...
By default, questchaind will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give questchaind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent questchaind from writing mempool.dat to disk. Verify that `savemempool` fails")
