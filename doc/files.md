...
* questchain.conf: contains configuration settings for questchaind or questchain-qt
* questchaind.pid: stores the process id of questchaind while running
...
* debug.log: contains debug information and general logging generated by questchaind or questchain-qt
