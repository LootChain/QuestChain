...
- [`2be67c760`](https://github.com/questchainpay/questchain/commit/2be67c760) Merge #12324: speed up Unserialize_impl for prevector
...
- [`c743111c6`](https://github.com/questchainpay/questchain/commit/c743111c6) Merge #11578: net: Add missing lock in ProcessHeadersMessage(...)
...
- [`cbf59efef`](https://github.com/questchainpay/questchain/commit/cbf59efef) Implement WalletModel::IsSpendable for CScript
...
- [`703f4c77a`](https://github.com/questchainpay/questchain/commit/703f4c77a) Fix stderr related issues
...
- [`689eff3aa`](https://github.com/questchainpay/questchain/commit/689eff3aa) Drop unused GetScriptForWitness
...
- [`c2e6a2f9c`](https://github.com/questchainpay/questchain/commit/c2e6a2f9c) Merge #10949: Clarify help message for -discardfee
...
- [`8c2c2a1ad`](https://github.com/questchainpay/questchain/commit/8c2c2a1ad) s/bitcoind/questchaind/ in some places
...
- [`d10e4e769`](https://github.com/questchainpay/questchain/commit/d10e4e769) Merge #10893: [QA] Avoid running multiwallet.py twice
...
- [`d6633b5fb`](https://github.com/questchainpay/questchain/commit/d6633b5fb) apply rpcconsole.cpp patch
...
- [`4079942b5`](https://github.com/questchainpay/questchain/commit/4079942b5) use old benchmark system
...
- [`9221e0d3c`](https://github.com/questchainpay/questchain/commit/9221e0d3c) Merge #10728: fix typo in help text for removeprunedfunds
...
- [`3f4d08d36`](https://github.com/questchainpay/questchain/commit/3f4d08d36) Merge #10565: [coverage] Remove subtrees and benchmarks from coverage report
...
- [`25008bd38`](https://github.com/questchainpay/questchain/commit/25008bd38) Small preparations for Q_FOREACH, PAIRTYPE and `#include <boost/foreach.hpp>` removal
...
- [`de33753f0`](https://github.com/questchainpay/questchain/commit/de33753f0) Revert "Merge #10376: [tests] fix disconnect_ban intermittency"
...
- [`5d5171f47`](https://github.com/questchainpay/questchain/commit/5d5171f47) remove unused gArgs wrappers
...
- [`23daebec7`](https://github.com/questchainpay/questchain/commit/23daebec7) Merge #10405: tests: Correct testcase in script_tests.json for large number OP_EQUAL
...
- [`6b9e864a0`](https://github.com/questchainpay/questchain/commit/6b9e864a0) Merge #10187: tests: Fix test_runner return value in case of skipped test
...
- [`dfabead29`](https://github.com/questchainpay/questchain/commit/dfabead29) Merge #10264: [test] Add tests for getconnectioncount, getnettotals and ping
...
- [`07b4c08bd`](https://github.com/questchainpay/questchain/commit/07b4c08bd) Merge #9951: Wallet database handling abstractions/simplifications
...
- [`250195185`](https://github.com/questchainpay/questchain/commit/250195185) Adjust CDSNotificationInterface to align with CValidationInterface changes
- [`d180061b8`](https://github.com/questchainpay/questchain/commit/d180061b8) Pass block index via BlockDisconnected
- [`282d1554d`](https://github.com/questchainpay/questchain/commit/282d1554d) adjust examples/questchain.conf
- [`e451325d6`](https://github.com/questchainpay/questchain/commit/e451325d6) Merge #10186: Remove SYNC_TRANSACTION_NOT_IN_BLOCK magic number
- [`60438257a`](https://github.com/questchainpay/questchain/commit/60438257a) Merge #9725: CValidationInterface Cleanups
- [`f893ac66c`](https://github.com/questchainpay/questchain/commit/f893ac66c) Merge #10124: [test] Suppress test logging spam
- [`a54ff70ff`](https://github.com/questchainpay/questchain/commit/a54ff70ff) Merge #9902: Lightweight abstraction of boost::filesystem
- [`515343963`](https://github.com/questchainpay/questchain/commit/515343963) Merge #10036: Fix init README format to render correctly on github
- [`c8a565d6e`](https://github.com/questchainpay/questchain/commit/c8a565d6e) Merge #10090: Update bitcoin.conf with example for pruning
- [`6f558270d`](https://github.com/questchainpay/questchain/commit/6f558270d) Merge #10143: [net] Allow disconnectnode RPC to be called with node id
- [`4efa99c2d`](https://github.com/questchainpay/questchain/commit/4efa99c2d) Merge #10221: Stop treating coinbase outputs differently in GUI: show them at 1conf
- [`16053cd52`](https://github.com/questchainpay/questchain/commit/16053cd52) Merge #10226: wallet: Use boost to more portably ensure -wallet specifies only a filename
- [`7fa60a1c7`](https://github.com/questchainpay/questchain/commit/7fa60a1c7) Merge #10219: Tests: Order Python Tests Differently
- [`0b232fd1c`](https://github.com/questchainpay/questchain/commit/0b232fd1c) Merge #10208: [wallet] Rescan abortability
- [`55d1251ff`](https://github.com/questchainpay/questchain/commit/55d1251ff) Merge #9480: De-duplicate SignatureCacheHasher
- [`29194b1f5`](https://github.com/questchainpay/questchain/commit/29194b1f5) Backport Bitcoin#9424, Bitcoin#10123 and Bitcoin#10153 (#2918)
- [`15fa1873d`](https://github.com/questchainpay/questchain/commit/15fa1873d) Drop redundant imports and fix related code
- [`6f91144f2`](https://github.com/questchainpay/questchain/commit/6f91144f2) Fix p2p-fingerprint.py
- [`92fed9254`](https://github.com/questchainpay/questchain/commit/92fed9254) Fix and re-enable pruning.py
- [`bfeb5bca4`](https://github.com/questchainpay/questchain/commit/bfeb5bca4) fix txindex.py and add it to extended scripts
- [`c37008a45`](https://github.com/questchainpay/questchain/commit/c37008a45) update dip4-coinbasemerkalroots.py and llmq-is-cl-conflicts.py
- [`7fd979cc0`](https://github.com/questchainpay/questchain/commit/7fd979cc0) Merge #10114: [tests] sync_with_ping should assert that ping hasn't timed out
- [`4121daba2`](https://github.com/questchainpay/questchain/commit/4121daba2) Merge #10098: Make qt wallet test compatible with qt4
- [`cc06ef551`](https://github.com/questchainpay/questchain/commit/cc06ef551) Merge #10109: Remove SingleNodeConnCB
- [`94aa904c0`](https://github.com/questchainpay/questchain/commit/94aa904c0) Merge #10107: Remove unused variable. Remove accidental trailing semicolons in Python code
- [`404e244d1`](https://github.com/questchainpay/questchain/commit/404e244d1) Merge #10088: Trivial: move several relay options into the relay help group
- [`05cb5a058`](https://github.com/questchainpay/questchain/commit/05cb5a058) Merge #10108: ApproximateBestSubset should take inputs by reference, not value
- [`bfd63c179`](https://github.com/questchainpay/questchain/commit/bfd63c179) Merge #10076: [qa] combine_logs: Use ordered list for logfiles
- [`e57559a8d`](https://github.com/questchainpay/questchain/commit/e57559a8d) Merge #10096: Check that all test scripts in test/functional are being run
- [`c2258978b`](https://github.com/questchainpay/questchain/commit/c2258978b) Merge #10057: [init] Deduplicated sigaction() boilerplate
- [`6bb55d547`](https://github.com/questchainpay/questchain/commit/6bb55d547) Merge #10056: [zmq] Call va_end() on va_start()ed args.
- [`142b5cba0`](https://github.com/questchainpay/questchain/commit/142b5cba0) Merge #10073: Actually run assumevalid.py
- [`14001a3d9`](https://github.com/questchainpay/questchain/commit/14001a3d9) Merge #10085: Docs: remove 'noconnect' option
- [`120941793`](https://github.com/questchainpay/questchain/commit/120941793) Merge #10083: [QA] Renaming rawTx into rawtx
- [`1781c7a70`](https://github.com/questchainpay/questchain/commit/1781c7a70) Merge #10069: [QA] Fix typo in fundrawtransaction test
- [`379312931`](https://github.com/questchainpay/questchain/commit/379312931) Merge #9946: Fix build errors if spaces in path or parent directory
- [`ba20c9031`](https://github.com/questchainpay/questchain/commit/ba20c9031) Merge #10067: [trivial] Dead code removal
- [`ae05068c5`](https://github.com/questchainpay/questchain/commit/ae05068c5) Merge #10053: [test] Allow functional test cases to be skipped
- [`9f07f489d`](https://github.com/questchainpay/questchain/commit/9f07f489d) Merge #10047: [tests] Remove unused variables and imports
- [`96a5f5730`](https://github.com/questchainpay/questchain/commit/96a5f5730) Merge #9500: [Qt][RPC] Autocomplete commands for 'help' command in debug console
- [`07e0567dc`](https://github.com/questchainpay/questchain/commit/07e0567dc) Merge #9558: Clarify assumptions made about when BlockCheck is called
- [`2aa3f890d`](https://github.com/questchainpay/questchain/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
- [`7edb9e15a`](https://github.com/questchainpay/questchain/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/questchainpay/questchain/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/questchainpay/questchain/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/questchainpay/questchain/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/questchainpay/questchain/commit/67c735b15) s/bitcoin-config.h/questchain-config.h/
- [`2f63322cd`](https://github.com/questchainpay/questchain/commit/2f63322cd) questchainify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/questchainpay/questchain/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/questchainpay/questchain/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/questchainpay/questchain/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/questchainpay/questchain/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/questchainpay/questchain/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/questchainpay/questchain/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/questchainpay/questchain/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/questchainpay/questchain/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/questchainpay/questchain/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/questchainpay/questchain/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/questchainpay/questchain/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/questchainpay/questchain/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/questchainpay/questchain/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/questchainpay/questchain/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/questchainpay/questchain/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/questchainpay/questchain/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/questchainpay/questchain/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/questchainpay/questchain/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/questchainpay/questchain/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/questchainpay/questchain/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/questchainpay/questchain/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/questchainpay/questchain/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/questchainpay/questchain/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/questchainpay/questchain/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/questchainpay/questchain/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/questchainpay/questchain/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/questchainpay/questchain/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/questchainpay/questchain/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/questchainpay/questchain/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/questchainpay/questchain/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/questchainpay/questchain/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/questchainpay/questchain/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/questchainpay/questchain/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/questchainpay/questchain/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/questchainpay/questchain/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/questchainpay/questchain/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/questchainpay/questchain/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/questchainpay/questchain/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/questchainpay/questchain/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/questchainpay/questchain/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/questchainpay/questchain/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/questchainpay/questchain/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/questchainpay/questchain/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/questchainpay/questchain/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/questchainpay/questchain/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/questchainpay/questchain/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/questchainpay/questchain/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/questchainpay/questchain/commit/1cfda206a) Merge #9993: Initialize nRelockTime
