...
This mechanism has been integrated into Bitcore-Node-QuestChain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/questchainpay/insight-api-questchain#web-socket-api](https://github.com/questchainpay/insight-api-questchain#web-socket-api)
* API: [https://github.com/questchainpay/insight-api-questchain#instantsend-transactions](https://github.com/questchainpay/insight-api-questchain#instantsend-transactions)
