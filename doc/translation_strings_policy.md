...
This document provides guidelines for internationalization of the QuestChain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `questchain_en.ts` remains unchanged.
