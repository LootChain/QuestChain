...
simple_types = ["CMasternode", "CMasternodeVerification",
                ...
                "CTransaction", "CMutableTransaction", "CQuestChainSendBaseSession",
                "CQuestChainSendBaseManager", "CQuestChainSendClientSession",
                "CQuestChainSendClientManager", "CQuestChainSendServer", "CMasternodePayments",
