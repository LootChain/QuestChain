Contributing to QuestChain Core
============================

The QuestChain Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to questchain-qt
...
[Translation Process](https://github.com/questchainpay/questchain/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the QuestChain Core project (and related
projects such as libsecp256k1), and is not to be confused with overall QuestChain
Network Protocol consensus changes.

Whether a pull request is merged into QuestChain Core rests with the project merge
...
Patches that change QuestChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the QuestChain consensus, it must have been
...
The review process is normally fairly responsive on the QuestChain Core repository, however
...
The project leader is the release manager for each QuestChain Core release.
